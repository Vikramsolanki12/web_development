...
function App() {
  ...
  const handleSendMessage = async (message) => {
    ...
    try {
      ...
      addMessage({
        text: "Sorry, I couldn't connect to the RoboAI brain.",
        sender: "bot",
      });
    } finally {
      setIsLoading(false);
    ...
    <div className="min-h-screen bg-robo-dark flex flex-col items-center justify-center p-6 font-futuristic">
      <div className="bg-robo-light rounded-xl shadow-lg p-8 w-full max-w-md flex flex-col">
        <div className="flex justify-center gap-2 ">
          <div className="h-11 w-11 rounded-full border-black border-2 overflow-hidden">
            <img
          ...
          <h1 className="text-4xl font-bold text-robo-dark text-center mb-4">
            {" "}
            JK Pulse
          </h1>
        </div>
